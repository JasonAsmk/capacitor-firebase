...
Pod::Spec.new do |s|
  ...
  s.subspec 'Analytics' do |analytics|
    analytics.dependency 'FirebaseAnalytics', '~> 12.0.0'
    analytics.dependency 'GoogleAppMeasurementOnDeviceConversion', '~> 12.0.0'
  end

  s.subspec 'AnalyticsWithoutAdIdSupport' do |analyticsWithoutAdIdSupport|
    analyticsWithoutAdIdSupport.dependency 'FirebaseAnalytics/WithoutAdIdSupport', '~> 12.0.0'
  end
end
